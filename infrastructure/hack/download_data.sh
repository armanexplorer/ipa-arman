...
function download_data(){
    ...
    gsutil cp -rnm 'gs://ipa-models/myshareddir/torchhub' ~/temp-model-dir
    gsutil cp -rnm 'gs://ipa-models/myshareddir/huggingface' ~/temp-model-dir
    ...
    gsutil cp -rm gs://ipa-models/lstm ~/ipa-private/data
}
